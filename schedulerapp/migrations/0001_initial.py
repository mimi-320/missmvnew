# Generated by Django 5.2.8 on 2026-01-30 05:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('theater', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='screens', to='schedulerapp.theater', verbose_name='映画館')),
            ],
            options={
